...
import { Sword, Users, CheckSquare } from "lucide-react"
    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-3.5rem)] px-4">
      <div className="text-center space-y-6 max-w-2xl">
        <div className="flex justify-center">
          <div className="rounded-full bg-blue-600/10 p-4 ring-1 ring-blue-600/20">
            <Sword className="h-12 w-12 text-blue-400" />
          </div>
        </div>
        <h1 className="text-4xl font-bold text-white">LOA 레이드 관리</h1>
